import { Implementation, TestFindings, ExpectedOutcome, ActualOutcome } from '../get-implementation'
...
function inconsistencyCount(count = 0, { expected, actual }: TestFindings): number {
